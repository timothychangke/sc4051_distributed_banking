...
*SC4051 Distributed Banking System — Generated 2026-03-27*
...
| Client Terminate (Exit option) | **PASS** | `bankIO.cpp:18` — menu shows `"0. EXIT"`. `bankClient.cpp:64-68` — input `0` returns `USER_QUIT`, breaking the run loop. |
